...
let textEngA="beatkino is a platform to stream a selection of independent cinema from around the world. Our goal is to collect remarkable works that might be dispersed and lost in the vast of the web. The films in our catalog are selected because for the unique voice and character of their authors, their accomplishments on the cinematic craft or for presenting a particular point of view on a significant topic.";
let textEngB="For the viewers, we look to offer an interesting and diverse catalog, an interesting alternative to mainstream media. For the authors, we mean to be a place to keep on display the work that could be considered past, a dynamic environment to keep the films close to viewers.";
